...
exports.install = function() {
	...
	ROUTE('+API    /api/    +profiles_test                          *Profiles    --> test');
	...
	ROUTE('+API    /api/    +templates_test/{profileid}             *Templates   --> test');
	ROUTE('+API    /api/    +templates_bulksend/{profileid}/{id}    *Templates   --> bulksend');
